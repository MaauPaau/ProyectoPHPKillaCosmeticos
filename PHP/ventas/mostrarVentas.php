...
$sql = "SELECT id_venta, fecha, id_cliente, id_empleado, id_tienda FROM ventas";
...
<head>
    <meta charset="UTF-8">
    <title>Ventas - Killa Cosméticos</title>
...
<table border="1">
   ...
   <td>
            <a href="editarVenta.php?id=<?php echo $fila['id_venta']; ?>" class="btn-edit">
                <i class="fas fa-edit"></i> Editar
            </a>
        </td>
        <td>
            <a href="eliminarVenta.php?id=<?php echo $fila['id_venta']; ?>" class="btn-delete"
